...
import com.subhrajit.mapper.CommentMapper;
...
import com.subhrajit.repository.CommentRepository;
...
public class CommentService {
    ...
    public boolean containsSwearWords(String comment) {
        if (comment.contains("shit")) {
            throw new OpenForumException("Comments contains unacceptable language");
        }
        return false;
    }
}
